...
\node[rectangle, draw=black!40, fill=black!10, minimum width=0.8\textwidth, minimum height=0.5in](charger1Box) at (0.5\textwidth,1){};
	...
	\draw[->, line width=1pt, shorten >=3pt] (delta1.west) -- (avail1.east);
	\draw[->, line width=1pt, shorten >=3pt] (delta1.east) -- (avail2.west);
	\node(delta2) at (0.505\textwidth,1){$\delta_i$}; 
	\draw[->, line width=1pt, shorten >=3pt] (delta2.west) -- (avail2.east);
	\draw[->, line width=1pt, shorten >=3pt] (delta2.east) -- (avail3.west);
	\node(delta3) at (0.73\textwidth,1){$\delta_i$}; 
	\draw[->, line width=1pt, shorten >=3pt] (delta3.west) -- (avail3.east);
	\draw[->, line width=1pt, shorten >=3pt] (delta3.east) -- (avail4.west);
\end{tikzpicture}
