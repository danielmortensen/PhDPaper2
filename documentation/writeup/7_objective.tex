...
\par The rate schedule given in \cite{rocky_mountain_power_rocky_2021} assesses a fee for a user's maximum average power during on-peak hours, called the On-Peak Power charge, and a user's overall maximum average power, called a facilities charge as shown in Fig. \ref{fig:charges}. 
...
\input{\rootdirectorytwo/media/7_objective/charges.tex}
